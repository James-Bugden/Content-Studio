...
const OPTIONAL = ['TYPEFULLY_API_KEY', 'TYPEFULLY_SOCIAL_SET_ID', 'AI_API_KEY', 'CS_VIEWER_GOOGLE_SUBS', 'CS_DRIVE_ROOT_FOLDER_ID', 'CS_ASSET_FOLDER_ID'];
const FORBIDDEN_IN_FAKE = ['GOOGLE_SERVICE_ACCOUNT_PRIVATE_KEY', 'TYPEFULLY_API_KEY', 'AI_API_KEY'];
