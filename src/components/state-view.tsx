...
export const STATE_LOOK: Record<StateKind, KindLook> = {
  ...
  no_match: {
    ...
    glyph: '∅',
    label: 'No match',
    frame: 'border border-dashed border-info bg-info-soft',
    mark: 'border-info text-info',
  ...
  not_configured: {
    ...
    frame: 'border border-info bg-info-soft border-l-4',
    mark: 'border-info text-info',
  ...
  conflict: {
    ...
    glyph: '⇄',
    label: 'Conflict',
    frame: 'border border-warn bg-warn-soft border-l-4',
    mark: 'border-warn text-warn',
  ...
  rate_limited: {
    ...
    glyph: '⧖',
    label: 'Rate limited',
    frame: 'border border-warn bg-warn-soft border-dashed',
    mark: 'border-warn text-warn',
